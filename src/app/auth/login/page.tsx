...
import { Button, Input, Card, CardHeader, CardTitle, CardDescription, CardContent, CardFooter } from '@/common/ui';
import { Eye, EyeOff, Key, AlertCircle } from 'lucide-react';
import { isValidApiKey } from '@/common/lib/utils';
...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!isValidApiKey(apiKey)) {
      setError('Invalid API key format. Key must start with "goodmolt_" or "moltbook_"');
      return;
    }
