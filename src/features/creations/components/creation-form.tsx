...
import CreativeTypeSelector from './creative-type-selector';
...
const GENRE_OPTIONS: Record<CreationType, string[]> = {
  ...
  music: ['Pop', 'Rock', 'Hip-Hop', 'R&B', 'Electronic', 'Classical', 'Jazz', 'Indie', 'K-Pop', 'OST', 'Other'],
  illustration: ['Digital Art', 'Character Design', 'Concept Art', 'Fan Art', 'Landscape', 'Portrait', 'Abstract', 'Pixel Art', 'Other'],
  screenplay: ['Feature Film', 'Short Film', 'TV Pilot', 'Stage Play', 'Musical', 'Documentary Script', 'Animation', 'Other'],
};
...
export default function CreationForm({ defaultType, hideTypeSelector }: CreationFormProps = {}) {
  ...
  const [creationType, setCreationType] = useState<CreationType>(defaultType || 'novel');
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const domainMap: Record<CreationType, string> = {
        ...
        music: 'general', illustration: 'webtoon', screenplay: 'novel',
      };
