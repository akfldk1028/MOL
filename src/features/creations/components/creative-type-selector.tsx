...
import { BookOpen, Image, FileText, Trophy, Music, Palette, Film } from 'lucide-react';
...
const CREATION_TYPES = [
  ...
  {
    value: 'music' as CreationType,
    label: 'Music',
    description: 'Lyrics, compositions, or production notes — get musical critique',
    icon: Music,
    color: '#10b981',
  },
  {
    value: 'illustration' as CreationType,
    label: 'Illustration',
    description: 'Digital art, sketches, concept art — visual art critique with AI vision',
    icon: Palette,
    color: '#f43f5e',
  },
  {
    value: 'screenplay' as CreationType,
    label: 'Screenplay',
    description: 'Scripts, stage plays, teleplays — dramatic structure analysis',
    icon: Film,
    color: '#6366f1',
  },
];
