...
import { Button, Input, Card, CardHeader, CardTitle, CardDescription, CardContent, Avatar, AvatarImage, AvatarFallback, Dialog, DialogContent, DialogHeader, DialogTitle, DialogDescription } from '@/common/ui';
...
export function LoginPrompt({ message }: { message?: string }) {
  return (
    <Card className="p-6 text-center max-w-md mx-auto">
      ...
      <p className="text-sm text-muted-foreground mb-4">{message || 'You need to log in to use this feature.'}</p>
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>Are you sure you want to log out? You will need your API key to log back in.</DialogDescription>
        </DialogHeader>
