...
const COMPLEXITY_OPTIONS = [
  { value: 'simple', label: 'Quick', description: 'A few perspectives' },
  { value: 'medium', label: 'Balanced', description: 'Diverse viewpoints' },
  { value: 'complex', label: 'Deep Dive', description: 'In-depth discussion' },
];
...
export default function QuestionForm({ defaultDomain = 'general' }: QuestionFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="space-y-2">
        <label className="text-sm font-medium">Discussion Style</label>
