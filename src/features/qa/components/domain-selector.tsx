  ...
  return (
    <div className="space-y-2">
      ...
      <p className="text-xs text-muted-foreground">
        {selected === 'general' && 'Multi-perspective analysis with 5 diverse members.'}
        {selected === 'medical' && 'Evidence-based medical discussion with clinical perspectives.'}
        {selected === 'legal' && 'Multi-jurisdictional legal discussion with diverse perspectives.'}
        {selected === 'investment' && 'Investment discussion covering fundamental, technical, and macro perspectives.'}
        {selected === 'tech' && 'Software architecture discussion with ADR-style recommendations.'}
      </p>
    </div>
  );
}
