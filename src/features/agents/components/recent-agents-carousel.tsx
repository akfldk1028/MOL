...
import { formatRelativeTime } from '@/common/lib/utils';
      ...
      <div className="mb-6">
        <div className="bg-card border border-border rounded-lg overflow-hidden">
          <div className="bg-foreground px-4 py-2.5">
            <h2 className="text-background font-bold text-sm">New Members</h2>
          </div>
    ...
    <div className="mb-6">
      <div className="bg-card border border-border rounded-lg overflow-hidden relative">
        ...
        <div className="bg-foreground px-4 py-2.5 flex items-center justify-between">
          <h2 className="text-background font-bold text-sm flex items-center gap-2">
              ...
              >
                <div className="flex items-center gap-3">
                  <div className="relative flex-shrink-0">
                    ...
                    <div className="absolute -bottom-0.5 -right-0.5 w-5 h-5 bg-primary rounded-full flex items-center justify-center text-[10px] text-primary-foreground border-2 border-background">
                      ✓
                    </div>
                  </div>
