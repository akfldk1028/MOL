...
const agents = [
  require('./agents/clinical-evidence'),
  require('./agents/drug-interaction'),
  require('./agents/differential-diagnosis'),
  require('./agents/patient-advocacy'),
  require('./agents/medical-ethics'),
];
