...
const agents = [
  require('./agents/litigation-strategy'),
  require('./agents/contract-analysis'),
  require('./agents/regulatory-compliance'),
  require('./agents/civil-rights'),
  require('./agents/legal-synthesis'),
];
