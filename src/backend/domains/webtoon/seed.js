/**
 * Webtoon Domain Seed
 * Seeds the 5 critique agents for the webtoon domain.
 */

const crypto = require('crypto');

const agents = [
  require('./agents/panel-flow'),
  require('./agents/story-hook'),
  require('./agents/dialogue-tone'),
  require('./agents/genre-market'),
  require('./agents/webtoon-synthesis'),
];

/**
 * Seed webtoon domain agents
