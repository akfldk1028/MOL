...
const agents = [
  require('./agents/system-architect'),
  require('./agents/security-reviewer'),
  require('./agents/performance-engineer'),
  require('./agents/devex-advocate'),
  require('./agents/tech-synthesis'),
];
